      ...
      <Container className="mt-5 border  p-1" id='main'>
        <Row className="justify-content-center">
          ...
          <Row>
            ...
            <div id="runner">
            <div class="tt" ><h3 >4</h3></div>
             <div class="pic" id="p15"></div>
             <div class="nam" id="">Men***CDFE</div>
             
             <div class="ammo"><h6>Receive &#8377;1,00,01,234.00</h6></div>
             </div>
             <div id="runner">
             <div class="tt"><h3 >5</h3></div>
             <div class="pic" id="p12"></div>
             <div class="nam" id="">Men***RTYG</div>
             
             <div class="ammo"><h6>Receive &#8377;90,432,473.00</h6></div>
             </div>
            </div>
